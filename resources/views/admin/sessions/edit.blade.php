    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sessions.update", [$session->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('sessiondatetime') ? 'is-invalid' : '' }}" type="text" name="sessiondatetime" id="sessiondatetime" value="{{ old('sessiondatetime', $session->sessiondatetime) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sessionlink') ? 'is-invalid' : '' }}" type="text" name="sessionlink" id="sessionlink" value="{{ old('sessionlink', $session->sessionlink) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('session_title') ? 'is-invalid' : '' }}" type="text" name="session_title" id="session_title" value="{{ old('session_title', $session->session_title) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Session::SESSION_DURATION_MINUTES_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('session_duration_minutes') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="session_duration_minutes_{{ $key }}" name="session_duration_minutes" value="{{ $key }}" {{ old('session_duration_minutes', $session->session_duration_minutes) === (string) $key ? 'checked' : '' }} required>
