...
@can('ticket_description_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'TicketDescription', 'route' => 'admin.ticket-descriptions.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-TicketDescription">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($ticketcategories as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'ticket_category_category_description', name: 'ticket_category.category_description' },
{ data: 'supporting_files', name: 'supporting_files', sortable: false, searchable: false },
{ data: 'supporting_photo', name: 'supporting_photo', sortable: false, searchable: false },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-TicketDescription').DataTable(dtOverrideGlobals);
