    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Module">
            <thead>
                <tr>
                    <th width="10"></th>
                    <th>{{ trans('cruds.module.fields.id') }}</th>
                    <th>{{ trans('cruds.module.fields.name') }}</th>
                    <!-- <th>{{ trans('cruds.module.fields.objective') }}</th> Add this line -->
                    <th>{{ trans('cruds.module.fields.description') }}</th>
                    <th>&nbsp;</th>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td><input class="search" type="text" placeholder="{{ trans('global.search') }}"></td>
                    <!-- <td><input class="search" type="text" placeholder="{{ trans('global.search') }}"></td> Add this line -->
                    <td><input class="search" type="text" placeholder="{{ trans('global.search') }}"></td>
                    <td></td>
                </tr>
            </thead>
