...
@can('assign_task_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.assign-tasks.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AssignTask">
            <thead>
                <tr>
                    <th width="10">
...
@can('assign_task_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.assign-tasks.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.assign-tasks.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AssignTask').DataTable(dtOverrideGlobals);
