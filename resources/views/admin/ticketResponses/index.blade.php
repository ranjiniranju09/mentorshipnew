                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($ticket_descriptions as $key => $item)
                                <option value="{{ $item->ticket_title }}">{{ $item->ticket_title }}</option>
                            @endforeach
                        </select>
                    </td>
                    <td>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.ticket-responses.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'ticket_description_ticket_title', name: 'ticket_description.ticket_title' },
