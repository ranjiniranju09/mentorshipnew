...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.guestspeakers.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="speakername">{{ trans('cruds.guestspeaker.fields.speakername') }}</label>
                <input class="form-control {{ $errors->has('speakername') ? 'is-invalid' : '' }}" type="text" name="speakername" id="speakername" value="{{ old('speakername', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('speaker_name') ? 'is-invalid' : '' }}" type="email" name="speaker_name" id="speaker_name" value="{{ old('speaker_name') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('speakermobile') ? 'is-invalid' : '' }}" type="number" name="speakermobile" id="speakermobile" value="{{ old('speakermobile', '') }}" step="1" required>
