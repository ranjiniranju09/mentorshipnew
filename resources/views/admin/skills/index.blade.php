...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Skill">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.skill.fields.skillname') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Skill').DataTable(dtOverrideGlobals);
