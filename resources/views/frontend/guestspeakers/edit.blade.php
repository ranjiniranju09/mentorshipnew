    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.guestspeakers.update", [$guestspeaker->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="speakername">{{ trans('cruds.guestspeaker.fields.speakername') }}</label>
                            <input class="form-control" type="text" name="speakername" id="speakername" value="{{ old('speakername', $guestspeaker->speakername) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="speaker_name" id="speaker_name" value="{{ old('speaker_name', $guestspeaker->speaker_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="speakermobile" id="speakermobile" value="{{ old('speakermobile', $guestspeaker->speakermobile) }}" step="1" required>
