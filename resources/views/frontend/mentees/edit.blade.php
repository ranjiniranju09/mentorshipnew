    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.mentees.update", [$mentee->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.mentee.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $mentee->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $mentee->email) }}" required>
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mobile" id="mobile" value="{{ old('mobile', $mentee->mobile) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="dob" id="dob" value="{{ old('dob', $mentee->dob) }}">
                            @if($errors->has('dob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dob') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="skilss" id="skilss" value="{{ old('skilss', $mentee->skilss) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="interestedskills" id="interestedskills" value="{{ old('interestedskills', $mentee->interestedskills) }}" required>
