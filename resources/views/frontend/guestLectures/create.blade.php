    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.guest-lectures.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="guessionsession_title">{{ trans('cruds.guestLecture.fields.guessionsession_title') }}</label>
                            <input class="form-control" type="text" name="guessionsession_title" id="guessionsession_title" value="{{ old('guessionsession_title', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="guestsession_date_time" id="guestsession_date_time" value="{{ old('guestsession_date_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\GuestLecture::GUEST_SESSION_DURATION_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="guest_session_duration_{{ $key }}" name="guest_session_duration" value="{{ $key }}" {{ old('guest_session_duration', '') === (string) $key ? 'checked' : '' }} required>
