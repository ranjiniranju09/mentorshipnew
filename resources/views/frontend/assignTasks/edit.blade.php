    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assign-tasks.update", [$assignTask->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.assignTask.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $assignTask->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $assignTask->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start_date_time" id="start_date_time" value="{{ old('start_date_time', $assignTask->start_date_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end_date_time" id="end_date_time" value="{{ old('end_date_time', $assignTask->end_date_time) }}" required>
