                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sessions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="sessiondatetime" id="sessiondatetime" value="{{ old('sessiondatetime') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sessionlink" id="sessionlink" value="{{ old('sessionlink', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="session_title" id="session_title" value="{{ old('session_title', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Session::SESSION_DURATION_MINUTES_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="session_duration_minutes_{{ $key }}" name="session_duration_minutes" value="{{ $key }}" {{ old('session_duration_minutes', '') === (string) $key ? 'checked' : '' }} required>
